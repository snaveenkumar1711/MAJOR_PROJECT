...
# exec cmd.exe /c "vlog bus_synchronizer.v"
# exec {*}[auto_execok start] vmap -c
# exec {*}[auto_execok start] vsim work.bus_synchronizer -do "do functional_verification/bus_synchronizer.do"


# Run the testbench
exec cmd.exe /c "vlib work"
exec cmd.exe /c "vlog bus_synchronizer.v"
exec cmd.exe /c "vlog functional_verification/bus_synchronizer_tb.v"
exec {*}[auto_execok start] vmap -c


# Generate the gray codes using the python script
exec cmd.exe /c "python functional_verification/gray_code_generator.py"
