...
tb_file = open('/home/naveensodad/MAJOR_PROJECT/functional_verification/bus_synchronizer/bus_synchronizer_tb.v', 'r')
code = tb_file.read()
...
gray_codes_file = open('/home/naveensodad/MAJOR_PROJECT/functional_verification/bus_synchronizer/gray_codes.txt', 'w')
