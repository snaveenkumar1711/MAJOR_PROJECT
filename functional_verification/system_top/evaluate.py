...
def parse_verilog_memory_file():
    memory_file = open('/home/naveensodad/MAJOR_PROJECT/functional_verification/system_top/output_files/register_file_verilog.mem', 'r')
...
memory_file = open('/home/naveensodad/MAJOR_PROJECT/functional_verification/system_top/output_files/register_file_python.mem', 'r')
...
system_outputs_python = open('/home/naveensodad/MAJOR_PROJECT/functional_verification/system_top/output_files/system_outputs_python.txt', 'r')
system_outputs_python = system_outputs_python.read().splitlines()

system_outputs_verilog = open('/home/naveensodad/MAJOR_PROJECT/functional_verification/system_top/output_files/system_outputs_verilog.txt', 'r')
