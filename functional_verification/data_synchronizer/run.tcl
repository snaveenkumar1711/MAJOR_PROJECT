...
exec cmd.exe /c "vlog data_synchronizer_tb.v"
exec {*}[auto_execok start] vmap -c

if {$argc == 0} {
    # Generate the inputs using the python script
    exec cmd.exe /c "python input_generator.py"
    ...
    # Open the waveform
    exec {*}[auto_execok start] vsim work.data_synchronizer -do "do data_synchronizer.do"
