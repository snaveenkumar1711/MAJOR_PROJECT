...
exec cmd.exe /c "vlog UART_receiver_controller_tb.v"
exec {*}[auto_execok start] vmap -c

if {$argc == 0} {
    # Run the testbench
    exec {*}[auto_execok start] vsim -c work.UART_receiver_controller_tb -do "run -all; quit -f"
    ...
    # Open the waveform
    exec {*}[auto_execok start] vsim work.UART_receiver_controller -do "do UART_receiver_controller.do"
